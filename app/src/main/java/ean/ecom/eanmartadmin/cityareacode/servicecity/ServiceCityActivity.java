...
import static ean.ecom.eanmartadmin.cityareacode.servicecity.ServiceAreaFragment.serviceAreaFragment;
import static ean.ecom.eanmartadmin.other.StaticValues.CLOSE_SERVICE;
import static ean.ecom.eanmartadmin.other.StaticValues.OPEN_SERVICE;

public class ServiceCityActivity extends AppCompatActivity {
    public static AppCompatActivity serviceCityActivity;
    ...
    public void onBackPressed() {
        if (CurrentFragment != 0){
            if (serviceAreaFragment != null){
                serviceAreaFragment.setBackFragment( new CityViewFragment() );
            }else{
                super.onBackPressed();
            }
//            setCityFrameLayout(new CityViewFragment());
