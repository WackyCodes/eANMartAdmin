...
import static ean.ecom.eanmartadmin.database.DBQuery.updateCityService;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        view.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (position<cityCodeAndNameList.size()){
                    // Click On City...
                    ServiceAreaFragment serviceAreaFragment = new ServiceAreaFragment( cityCodeAndNameList.get( position ).getCityCode() );
                     CityViewFragment.cityViewFragment.setFragment( serviceAreaFragment );
                }else{
                    // New City Add..
//                    TODO:
                }
