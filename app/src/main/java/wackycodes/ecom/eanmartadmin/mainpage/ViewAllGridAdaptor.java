...
import wackycodes.ecom.eanmartadmin.addnewitem.AddNewImageActivity;
...
public class ViewAllGridAdaptor extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        addNewItem.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialogToChangeName( parent.getContext(), catModelList.size(), null, true, catModelList.get( layoutIndex ).getLayoutId() );
            }
        } );
...
//                itemView.getContext().startActivity( intent );
    ...
    private void dialogToChangeName(final Context context, final int catNo, @Nullable String updateCatName, final boolean isNew, final String layoutID ){
